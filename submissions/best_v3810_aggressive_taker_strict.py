"""best_v3810_aggressive_taker_strict — v1610 + pca_residual_mr on OXYGEN_SHAKE_EVENING_BREATH/CHOCOLATE.
...
class Trader:
    def __init__(self):
        config = get_round_config(5, "best_v3810_aggressive_taker_strict")
