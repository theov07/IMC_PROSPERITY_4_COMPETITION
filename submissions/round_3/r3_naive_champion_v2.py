"""Backtester entrypoint — r3_naive_champion_v2 (fix: naive_tight_mm on delta-1)."""
...
class Trader:
    def __init__(self):
        config = get_round_config(3, "r3_naive_champion_v2")
    ...
    def bid(self) -> int:
        return 800   # placeholder Ornamental Bio-Pods bid
