"""best_v2200_basket_skip — v2090 + tracking_error_skip on naive products.

Needs SharedR5Context injected for tracking_error_skip_mm to read group mids.
"""
...
class Trader:
    def __init__(self):
        config = get_round_config(5, "best_v2200_basket_skip")
