...
from typing import Any, Dict, List, Sequence, Optional, Set, Tuple, Mapping
import json
import math
...
class VelvetMMV100(R3GuardedAnchorMMStrategy): pass
class GammaScalpV100(GammaScalpZGatedMixinStrategy): pass
class VEVOptionMMV100(VEVOptionMMV3): pass
class HydroMMV100(R3GuardedAnchorMMStrategy): pass
...
PRODUCTS = {'HYDROGEL_PACK': {'anchor_alpha': 0.02,
 ...
 'VEV_5400': {'ask_offset_neutral': 10,
              ...
              'zscore_threshold': 1.0,
              'zscore_window': 500},
 'VEV_5500': {'boost_when_cheap': False,
              'edge_ticks': 0.0,
              'enable_takers': False,
              'entry_size': 30,
              'entry_size_boost': 1.5,
...
STRATEGY_CLASSES = {"gamma_scalp_v100": GammaScalpV100, "hydro_mm_v100": HydroMMV100, "velvet_mm_v100": VelvetMMV100, "vev_option_mm_v100": VEVOptionMMV100}
