"""Trend carry market maker V38.

V38 sits between V36 and V37 on the startup path:

- fill the first inventory block quickly
- cool the middle block to reduce the early mark-to-market drawdown
- finish the last lots with a deadline so we do not stay under-invested

Goal: keep the cleaner startup shape from V37 without giving up too much carry.
"""
