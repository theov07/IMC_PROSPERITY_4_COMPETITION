...
class BaselineMarkedGammaScalpStrategy(GammaScalpZGatedStrategy):
...
PRODUCTS = {'VELVETFRUIT_EXTRACT': {'anchor_alpha': 0.02,
 ...
 'VEV_4000': {'boost_when_cheap': False,
              ...
              'strategy': 'baseline_marked_gamma',
              'strike': 4000,
              'take_edge': 3.0,
              'take_size': 40,
              'target_qty': 300,
...
STRATEGY_CLASSES = {"baseline_marked_gamma": BaselineMarkedGammaScalpStrategy, "gamma_scalp_zgated": GammaScalpZGatedStrategy, "r3_guarded_anchor_mm": R3GuardedAnchorMMStrategy, "vev_option_mm_v3": VEVOptionMMV3Strategy}
