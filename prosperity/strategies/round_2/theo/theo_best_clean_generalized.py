"""Theo best-clean-generalized family — chain of 4 strategies (v1→v4).

Extracted from submission 307401. Full tree:
  TheoBestCleanGeneralizedStrategy   — base (IPR regression + regime + gap_trap)
  TheoBestCleanGeneralizedV2Strategy — minor tweaks
  TheoBestCleanGeneralizedV3Strategy — dump_reserve + max_inv_guard
  TheoBestCleanGeneralizedV4Strategy — (v4 final, the live winner on IPR)
"""
