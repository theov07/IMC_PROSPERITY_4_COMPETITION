...
PRODUCTS = {'HYDROGEL_PACK': {'ema_alpha': 0.008,
                   ...
                   'risk_adverse_trend_threshold': 4.0,
                   'risk_force_giveback_threshold': 500.0,
                   'risk_giveback_window_ts': 14000,
                   'risk_hold_ts': 2000,
                   'risk_realized_progress_threshold': 8.0,
                   'risk_realized_stall_ts': 4000,
                   'risk_rebound_ticks_threshold': 14.0,
                   'risk_rebound_window_ts': 12000,
                   'risk_same_side_size_cap': 2,
                   'risk_take_size': 0,
                   'risk_target_position': 14,
                   'risk_trend_turn_threshold': 0.8,
                   'risk_unrealized_giveback_threshold': 150.0,
