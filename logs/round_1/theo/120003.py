...
# ── prosperity/strategies/naive_tight_mm_v21.py ───────────────────────────────────
...
PRODUCTS = {'ASH_COATED_OSMIUM': {'aggravate_min_frac': 0.2,
 ...
 'INTARIAN_PEPPER_ROOT': {'aggravate_min_frac': 0.2,
                          ...
                          'total_ticks': 10000000,
                          'ts_increment': 100,
                          'unwind_boost_frac': 0.4,
                          'unwind_min_position': 20,
                          'unwind_take_edge': 8.0}}

STRATEGY_CLASSES = {"book_following_trend_mm_v21": BookFollowingTrendMMV21Strategy, "naive_tight_mm_v10": NaiveTightMarketMakerV10Strategy}
