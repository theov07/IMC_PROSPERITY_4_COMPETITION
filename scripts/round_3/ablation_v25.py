...
Usage:
    python scripts/round_3/ablation_v25.py
    python scripts/round_3/ablation_v25.py --days 1   # quick single-day run
    python scripts/round_3/ablation_v25.py --out artifacts/analysis/round_3/ablation_v25.json
"""
