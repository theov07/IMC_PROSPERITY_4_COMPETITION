...
Usage:
  python scripts/round_4/cached_backtest.py --variant r4_v9_M22cond_z15_w04 --days 1 2 3
  python scripts/round_4/cached_backtest.py --variant r4_v9_M22cond_z15_w04 --days 3 --force
