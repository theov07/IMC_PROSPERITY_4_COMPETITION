...
Usage:
  python scripts/shared/export_submission.py --member champion --round 0
  python scripts/shared/export_submission.py --member leo --round 0 --output my_submission.py
