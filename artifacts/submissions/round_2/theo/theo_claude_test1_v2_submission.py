...
class TestTheoStrategy(Round1RegressionMMV5Strategy):
    ...
    def compute_orders(
        ...
        gap_sell_cap = int(self.params.get("gap_sell_cap", 5))
        ...
        if bullish and position >= int(self.params.get("gap_scout_floor_position", 75)):
            ...
            gap_scout_size_limit = int(self.params.get("gap_scout_size_limit", 10))
            ...
            in_gap_window = gap_scout_always_active or (
...
PRODUCTS = {
    'INTARIAN_PEPPER_ROOT': {
        ...
        # ── Gap scout: fire ANYTIME ask side is fragile (no time window restriction)
        'gap_scout_always_active': True,   # ignore time windows, fire on fragile ask always
        ...
        'gap_scout_size_limit': 10,        # increased from 7 to catch more premium
        'empty_side_shift': 85,
        'gap_sell_cap': 5,
    },
}
