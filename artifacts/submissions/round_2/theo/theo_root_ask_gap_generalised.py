"""Theo generalized ask-gap strategy for INTARIAN_PEPPER_ROOT.

Canonical round-2 Theo source file. This should be exported through
`scripts/export_submission.py`, not copied manually into `artifacts/`.
"""
...
class TheoRootAskGapGeneralisedStrategy(StrategyBase):
