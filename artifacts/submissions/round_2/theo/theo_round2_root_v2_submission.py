...
class TestTheoStrategy(Round1RegressionMMV5Strategy):
    ...
    def compute_orders(
        ...
        pullback_ready = startup_peak_spot - float(spot) >= startup_pullback_ticks
        chasing = bullish and not on_dip and (stretch >= chase_threshold or (startup_cold_loading and not pullback_ready))
