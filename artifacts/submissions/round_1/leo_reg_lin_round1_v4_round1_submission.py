...
# ── prosperity/strategies/round_1/regression_mm_v4.py ─────────────────────────────
...
class Round1RegressionMMV4Strategy(BaseStrategy):
    def _update_regression(
        ...
        *,
        ...
        fitted_now = anchor_mid + fixed_slope * tick_index
        ...
        local_intercept = anchor_mid + residual_mean
        fitted_now_adj = local_intercept + fixed_slope * tick_index
        forecast = local_intercept + fixed_slope * (tick_index + horizon)
        trend_ticks = fixed_slope * horizon * confidence
...
STRATEGY_CLASSES = {"round1_regression_mm_v4": Round1RegressionMMV4Strategy}
