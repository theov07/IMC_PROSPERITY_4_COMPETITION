...
# ── prosperity/strategies/naive_tight_mm_v25.py ───────────────────────────────────
...
PRODUCTS = {'ASH_COATED_OSMIUM': {'aggravate_min_frac': 0.2,
 ...
 'INTARIAN_PEPPER_ROOT': {'aggravate_min_frac': 0.25,
                          ...
                          'trim_extension_threshold': 1.75,
                          'trim_floor_position': 68,
                          'trim_sell_size': 4,
                          'trim_signal_edge': 1.0,
                          'trim_start_position': 72,
                          'ts_increment': 100,
...
STRATEGY_CLASSES = {"naive_tight_mm_v10": NaiveTightMarketMakerV10Strategy, "trend_carry_mm_v25": TrendCarryMMV25Strategy}
