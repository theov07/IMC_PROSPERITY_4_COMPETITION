...
# ── prosperity/strategies/buy_and_hold.py ─────────────────────────────────────────
...
PRODUCTS = {'ASH_COATED_OSMIUM': {'last_ts_value': 999900,
                       'log_flush_ts': 1000,
                       'maker_size': 20,
                       'position_limit': 80,
                       ...
                       'tighten_ticks': 1,
                       'ts_increment': 100},
 'INTARIAN_PEPPER_ROOT': {'last_ts_value': 999900,
                          'log_flush_ts': 1000,
                          'maker_size': 20,
                          'position_limit': 80,
                          'strategy': 'buy_and_hold',
...
STRATEGY_CLASSES = {"buy_and_hold": BuyAndHoldStrategy}
