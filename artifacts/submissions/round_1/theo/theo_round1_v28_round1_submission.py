...
# ── prosperity/strategies/naive_tight_mm_v26.py ───────────────────────────────────
...
PRODUCTS = {'ASH_COATED_OSMIUM': {'aggravate_min_frac': 0.2,
 ...
 'INTARIAN_PEPPER_ROOT': {'aggravate_min_frac': 0.25,
                          ...
                          'neutral_target': 0,
                          'position_limit': 80,
                          'rebuy_block_ticks': 30,
                          'short_alpha': 0.22,
                          'slope_window': 20,
                          'startup_buy_mult': 1.35,
                          'startup_target': 78,
                          'startup_ticks': 15000,
                          'strategy': 'trend_carry_mm_v26',
                          'stretch_weight': 0.75,
...
STRATEGY_CLASSES = {"naive_tight_mm_v10": NaiveTightMarketMakerV10Strategy, "trend_carry_mm_v26": TrendCarryMMV26Strategy}
