...
# ── prosperity/strategies/trend_carry_window.py ───────────────────────────────────
...
class TrendCarryWindowStrategy(BaseStrategy):
    ...
    def compute_orders(
        ...
        spot = book.microprice if book.microprice is not None else (
...
PRODUCTS = {'INTARIAN_PEPPER_ROOT': {'aggravate_min_frac': 0.25,
                          ...
                          'trim_ask_local_edge': 1.0,
                          'trim_cooldown_ticks': 10,
                          'trim_extension_threshold': 0.75,
                          'trim_floor_position': 72,
                          'trim_reference_slope_weight': 0.15,
                          'trim_sell_size': 2,
                          'trim_signal_edge': 0.75,
                          'trim_start_position': 76,
                          'trim_take_edge': 1.25,
                          'trim_take_position': 78,
                          'trim_take_sell_size': 2,
                          'trim_take_stretch': 1.25,
                          'ts_increment': 100,
...
STRATEGY_CLASSES = {"trend_carry_window": TrendCarryWindowStrategy}
