...
# ── prosperity/strategies/round_3/guarded_anchor_mm.py ────────────────────────────
...
# ── prosperity/strategies/round_4/gamma_scalp_zgated_slim.py ──────────────────────
...
# ── prosperity/strategies/round_4/hydro_reversion_mm_slim.py ──────────────────────
...
PRODUCTS = {'HYDROGEL_PACK': {'ema_alpha': 0.006,
                   'fast_ema_alpha': 0.025,
                   'inventory_reduce_per_unit': 0.4,
                   'inventory_unwind_per_unit': 0.2,
                   ...
                   'quote_threshold': 6.0,
                   'signal_pos_gate': 12,
                   'strategy': 'r4_hydro_reversion_mm_slim',
 ...
 'VEV_5300': {'boost_when_cheap': False,
              ...
              'use_smile': True,
              'zscore_boost_threshold': 1.0,
              'zscore_skip_threshold': 3.0,
              'zscore_window': 500},
 'VEV_5400': {'boost_when_cheap': False,
              'edge_ticks': 0.0,
              'enable_takers': False,
              'entry_size': 30,
              'entry_size_boost': 1.5,
...
STRATEGY_CLASSES = {"r3_guarded_anchor_mm": R3GuardedAnchorMMStrategy, "r4_gamma_scalp_zgated_slim": R4GammaScalpZGatedSlimStrategy, "r4_hydro_reversion_mm_slim": R4HydroReversionMMSlimStrategy}
