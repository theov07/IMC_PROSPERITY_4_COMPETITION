    ...
    def compute_orders(
        ...
        if guard_ok:
            taker_orders, buy_cap, sell_cap, taker_buy_px, taker_sell_px = self._ar_takers(
                book, order_depth, fair_value, dev, bid_size, ask_size, buy_cap, sell_cap
            )
        else:
...
STRATEGY_CLASSES = {"r4_hydro_mv_v6_invaware": R4HydroMVV6InvAwareStrategy}
