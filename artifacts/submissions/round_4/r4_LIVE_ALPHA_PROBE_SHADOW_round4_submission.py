...
# ── prosperity/strategies/round_4/live_alpha_probe_shadow.py ──────────────────────
...
PRODUCTS = {'VELVETFRUIT_EXTRACT': {'last_ts_value': 999900,
                         'log_flush_ts': 1000,
                         'position_limit': 200,
                         'strategy': 'live_alpha_probe_shadow',
                         'ts_increment': 100}}

STRATEGY_CLASSES = {"live_alpha_probe_shadow": LiveAlphaProbeShadowStrategy}
