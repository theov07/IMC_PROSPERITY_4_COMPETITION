...
# ── prosperity/strategies/round_5/fill_guarded_mm.py ──────────────────────────────
...
PRODUCTS = {'GALAXY_SOUNDS_BLACK_HOLES': {'last_ts_value': 999900,
 ...
 'GALAXY_SOUNDS_PLANETARY_RINGS': {'carry_pause_min_pos': 3,
                                   ...
                                   'trend_hl': 200,
                                   'ts_increment': 100},
 'GALAXY_SOUNDS_SOLAR_FLAMES': {'adverse_ticks': 1.0,
                                'carry_pause_min_pos': 3,
                                'favorable_ticks': 1.5,
                                'hard_pause_at': 9,
                                'last_ts_value': 999900,
                                'maker_size': 5,
                                'markout_horizon_ts': 500,
                                'mode': 'carry',
                                'pause_ticks': 4,
                                'position_limit': 10,
                                'strategy': 'fill_guarded_mm',
                                'tighten_ticks': 1,
                                'toxicity_decay': 0.96,
 ...
 'MICROCHIP_OVAL': {'hard_pause_at': 9,
                    ...
                    'ts_increment': 100,
                    'z_window': 300},
 'MICROCHIP_RECTANGLE': {'adverse_ticks': 1.0,
                         'favorable_ticks': 1.5,
                         'hard_pause_at': 9,
                         'last_ts_value': 999900,
                         'maker_size': 5,
