...
PRODUCTS = {'GALAXY_SOUNDS_BLACK_HOLES': {'last_ts_value': 999900,
 ...
 'MICROCHIP_RECTANGLE': {'last_ts_value': 999900,
                         ...
                         'tighten_ticks': 1,
                         'ts_increment': 100},
 'MICROCHIP_SQUARE': {'last_ts_value': 999900,
                      'log_flush_ts': 1000,
                      'maker_size': 5,
                      'position_limit': 10,
                      'strategy': 'naive_tight_mm',
 ...
 'OXYGEN_SHAKE_EVENING_BREATH': {'last_ts_value': 999900,
                                 ...
                                 'tighten_ticks': 1,
                                 'ts_increment': 100},
 'OXYGEN_SHAKE_GARLIC': {'last_ts_value': 999900,
                         'log_flush_ts': 1000,
                         'maker_size': 5,
                         'position_limit': 10,
                         'strategy': 'naive_tight_mm',
 ...
 'PEBBLES_XL': {'hard_pause_at': 9,
                ...
                'ts_increment': 100,
                'z_window': 300},
 'ROBOT_DISHES': {'last_ts_value': 999900,
                  'log_flush_ts': 1000,
                  'maker_size': 5,
                  'position_limit': 10,
                  'strategy': 'naive_tight_mm',
                  'tighten_ticks': 1,
                  'ts_increment': 100},
 'ROBOT_IRONING': {'last_ts_value': 999900,
                   'log_flush_ts': 1000,
                   'maker_size': 5,
                   'position_limit': 10,
                   'strategy': 'naive_tight_mm',
 ...
 'ROBOT_LAUNDRY': {'last_ts_value': 999900,
                   ...
                   'tighten_ticks': 1,
                   'ts_increment': 100},
 'SLEEP_POD_COTTON': {'last_ts_value': 999900,
                      'log_flush_ts': 1000,
                      'maker_size': 5,
                      'position_limit': 10,
                      'strategy': 'naive_tight_mm',
                      'tighten_ticks': 1,
                      'ts_increment': 100},
 'SLEEP_POD_NYLON': {'last_ts_value': 999900,
                     'log_flush_ts': 1000,
                     'maker_size': 5,
                     'position_limit': 10,
                     'strategy': 'naive_tight_mm',
                     'tighten_ticks': 1,
                     'ts_increment': 100},
 'SLEEP_POD_POLYESTER': {'last_ts_value': 999900,
                         'log_flush_ts': 1000,
                         'maker_size': 5,
                         'position_limit': 10,
                         'strategy': 'naive_tight_mm',
 ...
 'TRANSLATOR_VOID_BLUE': {'last_ts_value': 999900,
                          ...
                          'tighten_ticks': 1,
                          'ts_increment': 100},
 'UV_VISOR_AMBER': {'last_ts_value': 999900,
                    'log_flush_ts': 1000,
                    'maker_size': 5,
                    'position_limit': 10,
                    'strategy': 'naive_tight_mm',
...
STRATEGY_CLASSES = {"naive_tight_mm": NaiveTightMarketMakerStrategy, "pair_skip_mm": PairSkipMMStrategy}
