...
STRATEGY_CLASSES = {"gamma_scalp": GammaScalpStrategy, "naive_tight_mm": NaiveTightMarketMakerStrategy, "option_mm_bs": OptionMMBSStrategy, "velvet_delta_hedger": VelvetDeltaHedgerStrategy}
