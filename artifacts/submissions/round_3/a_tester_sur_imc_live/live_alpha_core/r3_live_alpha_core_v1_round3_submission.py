...
STRATEGY_CLASSES = {"gamma_scalp_zgated": GammaScalpZGatedStrategy, "mm_first_v4_combo": MMFirstV4ComboStrategy, "naive_tight_mm": NaiveTightMarketMakerStrategy, "option_mm_bs": OptionMMBSStrategy}
