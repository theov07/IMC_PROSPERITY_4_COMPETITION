...
PRODUCTS = {'HYDROGEL_PACK': {'conflict_quote_size': 0,
...
STRATEGY_CLASSES = {"hydro_velvet_spread_skew_mm": HydroVelvetSpreadSkewMMStrategy, "naive_tight_mm": NaiveTightMarketMakerStrategy, "option_mm_bs": OptionMMBSStrategy}
