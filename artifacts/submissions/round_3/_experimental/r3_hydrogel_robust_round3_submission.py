...
# ── prosperity/strategies/round_3/hydrogel_robust_mm.py ───────────────────────────
...
PRODUCTS = {'HYDROGEL_PACK': {'agg_maker_size': 30,
...
STRATEGY_CLASSES = {"hydrogel_robust_mm": HydrogelRobustMMStrategy}
