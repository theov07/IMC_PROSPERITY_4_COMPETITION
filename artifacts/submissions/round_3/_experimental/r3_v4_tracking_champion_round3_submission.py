...
PRODUCTS = {'HYDROGEL_PACK': {'anchor_alpha': 0.0,
                   'ar_gain': 0.3,
 ...
 'VELVETFRUIT_EXTRACT': {'anchor_alpha': 0.0,
                         'ar_gain': 0.3,
                         'ar_shift_source': 'mid_smooth',
                         'full_capacity_on_empty': True,
                         'inventory_aversion_gamma': 0.0015,
...
STRATEGY_CLASSES = {"mm_first_v4_combo": MMFirstV4ComboStrategy, "option_mm_bs": OptionMMBSStrategy}
