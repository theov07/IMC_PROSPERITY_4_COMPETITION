...
PRODUCTS = {'HYDROGEL_PACK': {'hard_trend_threshold': 999.0,
                   'inventory_reduce_ratio': 0.6,
                   'inventory_stop_ratio': 0.8,
...
STRATEGY_CLASSES = {"r3_live_defensive_mm": R3LiveDefensiveMMStrategy}
