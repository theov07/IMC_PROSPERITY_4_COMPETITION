...
# ── prosperity/strategies/naive_tight_mm_v3.py ────────────────────────────────────
...
class NaiveTightMarketMakerV3Strategy(BaseStrategy):
    ...
    def compute_orders(
        ...
        log.append([state.timestamp, front_bid, front_ask, buy_cap, sell_cap])
...
STRATEGY_CLASSES = {"naive_tight_mm_v3": NaiveTightMarketMakerV3Strategy}
