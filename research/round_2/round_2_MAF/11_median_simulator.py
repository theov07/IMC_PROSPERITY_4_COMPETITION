...
Usage:
    python research/round_2/round_2_MAF/11_median_simulator.py --scenario central --n-sims 2000
    python research/round_2/round_2_MAF/11_median_simulator.py --scenario pessimistic
    python research/round_2/round_2_MAF/11_median_simulator.py --scenario optimistic
    python research/round_2/round_2_MAF/11_median_simulator.py --scenario competitive
"""
