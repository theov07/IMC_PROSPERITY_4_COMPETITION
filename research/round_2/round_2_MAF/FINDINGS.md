...
python research/round_2/round_2_MAF/06_estimate_maf_live_gain.py \
...
python research/round_2/round_2_MAF/07_parse_live_logs.py \
    --logs "Downloads/log_2_champion_combine/308318.log" \
           ...
           ... \
    --save-json research/round_2/round_2_MAF/live_logs_summary.json
...
- `research/round_2/round_2_MAF/05_subsample_80pct.py` — générateur data 80%
- `research/round_2/round_2_MAF/06_estimate_maf_live_gain.py` — mesure uplift
- `research/round_2/round_2_MAF/07_parse_live_logs.py` — parser logs IMC
- `research/round_2/round_2_MAF/08_maf_breakeven_report.py` — rapport final
- `research/round_2/round_2_MAF/live_logs_summary.json` — PnL par run des 8 logs
